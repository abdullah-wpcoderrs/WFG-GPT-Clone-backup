...
export default function AdminChatsPage() {
  ...
  // Filter chats for the current admin user
  const adminChats = mockChatSessions.filter((session) => session.user_id === "admin-1")

  const filteredChats = adminChats.filter((chat) => {
    const matchesSearch =
